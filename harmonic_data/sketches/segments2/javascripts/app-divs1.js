...
$(function(){
  ...
  var dataset2 = dataSegments

  var g = d3.select("#timeline-container").selectAll(".album-container")
      .data(dataset2)
    .enter().append("div")
      .attr("class", ".album-container2")
  ...
  _.each(dataset2, function(album){
    $('#timeline-container').append("")
  })

  albumContainerView = Backbone.View.extend({
    className: 'album-container',
    initialize: function(){
      this.render()
    },
    template: function(attribiutes){
